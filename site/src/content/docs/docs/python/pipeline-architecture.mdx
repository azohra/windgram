...
| History mechanics | `history.py`, `repack.py` | Split gzip members, recompute each month's [sidecar byte-offset index](/docs/data/history/#the-sidecar-index) after every append, one-time repack of the legacy year archives |
