...
([`models.json`](https://github.com/azohra/windgram/blob/main/models.json)) declares what
...
`capabilities.smoke` carries three values because "this model publishes
...
separate [smoke document](/docs/reference/smoke-document/) from another
...
arithmetic — see [Smoke and thermals](/docs/learn/smoke-and-thermals/).
