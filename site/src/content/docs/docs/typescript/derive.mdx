...
alignment, units, smoothing, run freshness, and parameterized usable lift. It does not
...
[quarantined from derived optics](/docs/reference/smoke-document/#the-column-field-carries-a-provider-defect)
...
[ingest recipe](/docs/typescript/run-an-ingest/#judge-freshness-with-runfreshness).
