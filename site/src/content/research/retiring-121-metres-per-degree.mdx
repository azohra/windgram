---
title: "Retiring 121 metres per degree"
...
recorded with gratitude in the [windgram derivations](/docs/python/derivation-science/); the estimate
...
[derivation reference](/docs/python/derivation-science/) and in `pipeline/src/windgram/derive.py`.
...
[Why usable lift can sit above the boundary layer](/research/usable-lift-and-boundary-layer/) describes.
