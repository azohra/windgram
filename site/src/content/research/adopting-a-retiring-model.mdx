---
title: "Adopting a model two months before its retirement"
...
order: 5
scenarios: []
thumbnail: "model-succession"
---

import CapabilityProvenance from "../../components/research/CapabilityProvenance.astro";
import ModelLifecycleTimeline from "../../components/research/ModelLifecycleTimeline.astro";
...
[feed reference](/docs/reference/forecast-model-feeds/) records the inventories, the product split,
...
entries from the day they were published (see [`data/models.json`](https://github.com/azohra/windgram/blob/main/data/models.json)). A
...
[feed reference](/docs/reference/forecast-model-feeds/) records the verification.
...
its own successor is scheduled. The [feed reference](/docs/reference/forecast-model-feeds/) records
