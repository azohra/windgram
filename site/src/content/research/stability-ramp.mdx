---
title: "The stability field is background"
summary: "A pale register, measured colour-vision floors, and the lineage behind the shipped ramp"
...
The shipped default, [`STABILITY_TOKEN_DEFAULTS`](https://github.com/azohra/windgram/blob/main/packages/windgram/src/svg/index.ts), is that
