...
Run as a module it builds the HRDPS 2.5 km baseline; windgram.build_rdps
and windgram.build_gdps are the other models' entry points. Set
WINDGRAM_MAX_STEPS to cap the forecast steps fetched (used by smoke tests)
and WINDGRAM_DATAMART_BASE to fetch from the hpfx mirror instead of dd
(see windgram.datamart).
"""
