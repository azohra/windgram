 ...
 * and since 0.7.0 the return is honestly nullable for ANY Scalar input: a
 * full-dropout ensemble position ({ members: 0 }, every percentile null)
 * has no median, so its p50 is null too.
 */
