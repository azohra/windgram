...
![Typed data in, chart out: the package validates a published profile document and serializes the reference windgram](https://raw.githubusercontent.com/azohra/windgram/main/assets/package-hero.svg)
...
[`toolkit/schema/`](https://github.com/azohra/windgram/tree/main/toolkit/schema).
...
```sh
pnpm --dir toolkit test      # vitest
pnpm --dir toolkit build     # tsc -> dist/ (types + ESM)
pnpm --dir toolkit schemas   # regenerate schema/*.json
```
